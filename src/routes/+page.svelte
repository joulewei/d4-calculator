...
>
	...
	>
		...
		<div
			class="flex items-center gap-4 rounded-sm border border-orange-800/60 bg-orange-950/40 px-4 py-1.5 shadow-inner"
		>
			<span class="text-xs font-semibold tracking-wider text-orange-300 uppercase"
				>Total Expected Damage:</span
			>
	...
	<section class="rounded-sm border border-slate-800 bg-slate-800/40 p-2 shadow-sm">
		...
		<div class="flex flex-col gap-1">
			...
			>
				...
				<span class="col-span-5 text-right font-mono text-[11px] font-medium text-green-400">
					+{formatNumber(player.getSkillDamageGain(10))}
					<span class="text-[9px] text-slate-500">per 10%</span>
				</span>
			</div>
